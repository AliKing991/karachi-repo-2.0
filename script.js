...
// Group click from header
document.getElementById("chatPartnerInfo")?.addEventListener("click",()=>{
  if(currentChatIsGroup&&currentChatUser)viewGroupInfo(currentChatUser);
  else viewProfile();
});
